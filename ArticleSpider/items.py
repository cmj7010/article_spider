...
class JobBoleArticleItem(scrapy.Item):
    ...
    front_image_url = scrapy.Field(
        output_processor=MapCompose(return_value)#由一个值变为list
    )
    ...
    def get_insert_sql(self):
        ...
        params = (self["title"], self["url"], self["url_object_id"], self["create_date"],
                  self["front_image_url"], self["front_image_path"], self["praise_nums"],
                  self["comment_nums"],self["tags"],self["fav_nums"])
